...
plotRIN <- function(temp = c("56", "62"), ...) {
    ...
    plotData <- function(df) {
        ...
        if (temp == 62) {
            ...
            plot_mar <- c(0.8, 0.1, 0.5, 0.1)
            x_coord <- c(9.1, 4.15, 7.7, 7.837, 3.59, 4.1, 8.268, 7.8)
